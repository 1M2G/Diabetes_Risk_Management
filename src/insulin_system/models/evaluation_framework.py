...
class EvaluationFramework:
    ...
    def run_for_model(
        ...
        X_val = pipeline_result.X_val.values
        y_val = pipeline_result.y_val.values
        ...
        ev_val = evaluate_model(estimator, X_val, y_val, model_name=model_name, labels=labels)
        ...
        payload = {
            "test": _to_serializable(ev_test.__dict__),
            "train": _to_serializable(ev_train.__dict__),
            "val": _to_serializable(ev_val.__dict__),
        ...
        if self._cfg.plot_learning_curve:

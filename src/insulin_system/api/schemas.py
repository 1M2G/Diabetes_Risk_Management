...
class PredictionResponse(BaseModel):
    ...
    predicted_class: str = Field(..., description="Insulin category: down, up, steady, or no")
...
class ExplanationDriver(BaseModel):
    """Single feature driver for explanation."""
...
class ExplainResponse(BaseModel):
    ...
    predicted_class: str
    confidence: float
    top_drivers: List[ExplanationDriver] = Field(default_factory=list)

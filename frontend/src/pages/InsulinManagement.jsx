...
import { GLUCOSE_MIN, GLUCOSE_MAX, IOB_MAX_ML, ANTICIPATED_CARBS_MAX_G } from '../constants'
...
const FALLBACK_ZONES = [
  { id: 'hypo', min_mg_dl: null, max_mg_dl: 69, label: 'Below 70', interpretation: 'Hypoglycemia (Low)', action: 'Stop. Suspend all insulin logic. Prompt user to consume 15g fast-acting carbs.', severity: 'critical' },
